...
## replication first and do the same analysis they did originally (participants + databases) body specificity hypothesis 

- they did this: Materials and procedure We analyzed valence-normed words
from three corpora (see Appendix A in the Supplementary
online materials): the Affective Norms for English Words corpus
(ANEW; Bradley & Lang, 1999), and two translation
...
controlled [b 0 .057, Wald χ2(1) 0 6.95, p 0 .008]. (word length, letter frequency, and RSA since we aren't doing language).
...
experiment 3 is the pseudowords - we used these for our pseudowords

does talk about dodds here http://casasanto.com/QWERTY.html (so add warriner)

## extend the study - adding in expertise (main effect plus other variables: hand and finger switching)

they tossed this shit in the discussion with no evidence for it 

In exploratory analyses, we found no
significant relationship between the number of finger repetitions
in a word and its valence, nor was there any relationship
...
repetition and hand alternation are controlled.

## explore for an interaction between these two hypotheses 
...
FIX THE NUMBER OF WORDS AND SHIT HERE - FIGURE OUT WHERE THEY ARE FROM 
